...
本文记录 v0.4 完成时 Docengine 的边界、当前完成度、目标架构和到 1.0
...
综合看，距离“完备、可稳定嵌入的通用文档编排内核”约完成 59%，误差约
±10%。最难的存储、原子事务、资源策略和坐标变更地基已经存在；尚未完成的约 41%
主要是虚拟化、搜索、组合、后台任务治理和生产级验证，而不是继续堆叠
编辑 API。
